		...
		<table>
			...
			<c:forEach items="${requests}" var="request">
				<tr>
					...
					<td colspan="3"><c:out value="${request.reason}" /></td>
					...
					<td colspan="2"><c:set var="dat"
						...
						<td><a href="<c:out value=" move?requestId=${request.id }&from=3" />" >Process It</a>
					</td>
						<td><a href="<c:out value="reject?requestId=${request.id }&from=3" />" >Reject It</a>
					</td>
				</tr>
			</c:forEach>
		</table>
