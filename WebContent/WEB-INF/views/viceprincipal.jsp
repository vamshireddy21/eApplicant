...
<body>
	<nav>| <a href="welcome">Log out</a> </nav>
	<center>
		<h1>Vice Principal portal</h1>
		<h4>${errorMessage}</h4>
		<br> <br> <br> <br>
		...
		<table>
			...
			<c:forEach items="${requests}" var="request">
				<tr>
					...
					<td><a
						href="<c:out value=" move?requestId=${request.id }&from=5" />">Apply
							Signature</a></td>
					<td><a
						href="<c:out value="reject?requestId=${request.id }&from=5" />">Reject</a>
					</td>
				</tr>
			</c:forEach>
		</table>
